...
```python
mutation_05_de_movement(obj_function, x_r0_old, x_r1_old, x_best, x_lower, x_upper, n_dimensions, f, none_variable=None)
```
...
<p align = "justify">
    <i>
        Use the <code>mutation_05_de_movement</code> function to perform a task.
    </i>
</p>
