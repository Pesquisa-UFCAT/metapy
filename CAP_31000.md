...
<ul>
<li>O decaimento \( T_{1} \) que representa uma diminuição controlada com a função:<br>\(T<small>k+1</small> = 0.9T<small>k</small> \).<br></li>
<li>O decaimento \( T_{2} \) que representa uma diminuição lenta com a função:<br>\(T<small>k+1</small> = T<small>k</small>(log(100)/log(100 + <small>k</small>)) \).<br></li>
<li>O decaimento \( T_{3} \) que representa uma diminuição rápida com a função:<br>\(T<small>k+1</small> = T<small>k</small>/(1 + ((log(1 + \sigma)/3\sigma \).<br></li>
</ul>
