...
A cada iteração a temperatura diminui, ao diminuir a temperatura temos também a diminuição da probabilidade de aceitação, logo a cada iteração temos iteração temos uma diminuição da probabilidade de aceitação.<br>
