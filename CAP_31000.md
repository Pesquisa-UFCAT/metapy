...
<li>\( prob \) (<font face="Courier New">PROB</font>) é o valor da probabilidade de aceite da solução. Para valores de \( \Delta E >= 0 \) utilizar \( e^{\frac{-\Delta E}{T}} \).Já para valores de \( \Delta E < 0 \) o valor da probabilidade de aceite é 1.</li>
