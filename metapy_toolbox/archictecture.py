...
from metapy_toolbox import funcs as funcs
...
def two_algorithms_crossover_01_architecture(obj: Callable, n_gen: int, initial_population: np.ndarray, x_lower: list, x_upper: list, params_opt: dict, args: Optional[tuple] = None) -> tuple[np.ndarray, np.ndarray]:
