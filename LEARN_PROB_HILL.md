...
<h4>1. Exploração da Vizinhança</h4>
<p>Na primeira iteração, o algoritmo gera um novo candidato explorando a vizinhança da solução atual. Este processo é realizado utilizando uma distribuição normal \( \text{N}(\mu, \sigma) \), onde:</p>
<ul>
