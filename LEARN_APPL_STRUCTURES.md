...
<table border="0" style="width:100%">
    ...
    <tr>
        <td align="left">\[M_{u} = 0.9 A_{s} F_{y} (0.8h) \left(1.0 - 0.59 \frac{A_{s} F_{y}}{0.8bh \sigma_{c}}\right) \geq 1.4M_{d} + 1.7M_{l}\]</td>
...
<table border="0" style="width:100%">
  ...
  <tr>
    <td align="left">\[g_{6} = \frac{PL^{3}}{3E} \left(\frac{1}{l_5} + \frac{7}{l_4} + \frac{19}{l_3} + \frac{37}{l_2} + \frac{61}{l_1}\right) - \Delta_m \leq 0\]</td>
...
<table border="0">
  ...
  <tr>
    <td align="left">\(\sigma_d\) = Tensão de flexão admissível;</td>
  </tr>
  <tr>
    <td align="left">\(\Delta_m\) = Deslocamento admissível;</td>
  </tr>
</table>
